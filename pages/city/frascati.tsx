...
export default function Frascati () {
  return (
    <div>
    <Header />
    <DetailFrascati />
  ...
  function DetailFrascati(){
    const person = fathers.find((el)=> 'Padre Youhanna el Antony Ava Mousa'===el.name)
    return (
        ...
        <section className="text-gray-800">
          ...
          <div className="flex w-full justify-center">
            <h1 className="text-4xl lg:text-5xl mt-12 font-extrabold text-center px-2 border-b-2 border-sand-dark w-3/4 lg:w-1/2 lg:ml-auto lg:mr-auto mx-12 sm:mx-24 pb-2">
              <span>Chiesa della Santa Vergine Maria</span>
            </h1>
          </div>
